<?php
/* Template Name: Hire Dedicated Developer  */
?>
<!doctype html>
<html ⚡>
<head>
    ...
    <script async src="https://cdn.ampproject.org/v0.js"></script>
     ...
     <!-- Meta -->
     <meta name="description" content="Hire dedicated resources & developers from Yudiz, a leading Blockchain, Game, and Metaverse development company.">
     ...
     <style amp-boilerplate> body{-webkit-animation:-amp-start 8s steps(1,end) 0s 1 normal both;-moz-animation:-amp-start 8s steps(1,end) 0s 1 normal both;-ms-animation:-amp-start 8s steps(1,end) 0s 1 normal both;animation:-amp-start 8s steps(1,end) 0s 1 normal both}@-webkit-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-moz-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-ms-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@-o-keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}@keyframes -amp-start{from{visibility:hidden}to{visibility:visible}}</style><noscript><style amp-boilerplate>body{-webkit-animation:none;-moz-animation:none;-ms-animation:none;animation:none}</style></noscript>
      <style amp-custom>
         ...
         *                                               { margin: 0px; padding: 0px; box-sizing:border-box; }
         ...
         .desktop-mega-header .desktop-primary-menu li.about-megamenu .sub-menu { margin-top: 0; top: 100%; border-top: 0; left:32%; right:10px; margin: 0 !important; max-width:55%; width: auto; background: #FFFFFF; box-shadow: 0px 5px 16px rgba(0, 0, 0, 0.09); }
         ...
         .desktop-mega-header .desktop-primary-menu li.about-megamenu .sub-menu li { background: transparent; }
         ...
         .desktop-mega-header .desktop-primary-menu li.product-megamenu .sub-menu { margin-top: 0; top: 100%; border-top: 0; left:auto; right:10px; margin: 0; max-width:81%; width: auto; background: #FFFFFF; box-shadow: 0px 5px 16px rgba(0, 0, 0, 0.09); }
         .desktop-mega-header .desktop-primary-menu li.product-megamenu .sub-menu > li { margin:0; float: none; }
         .our-product-wrapper                            { display: flex; width:100%; }
         .our-product-wrapper .product-wrapper-left      { padding:0; width:calc(100% - 30%); }
         .our-product-wrapper .product-wrapper-right     { padding:20px 32px; background-color: #F0F7FF; width:30%; }
         ...
         .dropdown-new-menu .sub-menu li:after           { opacity: 0; content:""; position: absolute; right:0; top:50%; transform: translateY(-50%); width:9px; height: 11px; background: url('https://www.yudiz.com/wp-content/themes/yudiz/images/polygon-menu.svg')no-repeat center center/cover; }
         ...
         /* Header Style End */
         /* Footer Style ============================= */
         footer aside, footer aside ul                   { margin-bottom: 0px; }
         ...
         .footer-logo amp-img                                { width: 191px; height: 50px; aspect-ratio: 1/0.27; }
         .footer-company-text, .footer-address-block .widget_custom_html { color: rgba(255,255,255,0.8); font-weight: 300; }
         .footer-review-icons                            { text-align: right; }
         .footer-review-icons a                          { margin-left: 15px; display: inline-block; }
         .footer-company-text p, .footer-address-block .widget_custom_html p  { font-size: 16px; line-height: 28px; }
         ...
         .footer-address-block .widget_custom_html p img { object-fit: cover; overflow: hidden; margin: auto 8px auto 0px !important; height: 20px !important; width: 27.5px; vertical-align: middle !important; }
         ...
         #menu-footer-links li.current_page_item a, #menu-footer-links li.current-menu-item a { font-weight: 700; text-decoration: none; opacity: 1; }
         #menu-footer-links li a:hover                   { opacity: 1; }
         .footer-contact                                 { padding: 40px; position: relative; overflow: hidden; z-index: 1; }
         .footer-contact:before, .footer-contact:after   { position: absolute; bottom: 0; right: 0; height: 100%; width: 100%; border: 1px solid #4A4A4A; content: ""; display: block; }
         ...
         .site-info small, #menu-copyright-links li a    { color: rgba(255,255,255,0.30); }
         #menu-copyright-links li.current_page_item a, #menu-copyright-links li a:hover { color: #fff; }
         ...
         .menu-footer-social-menu-container li a:hover, .menu-footer-social-menu-container li a:focus { text-decoration: none; }
         .menu-footer-social-menu-container li a::after, #menu-footer-links li a::after, .footer-contact li a::after { content: ""; display: block; width: 0; height: 1px; background-color: rgba(255,255,255,0.8); position: absolute; bottom: 0; left: 0; }
         .menu-footer-social-menu-container li a::after  { width: 100%; animation: none; }
         #menu-footer-links li a::after, .footer-contact li a::after { background-color: #ffffff; }
         .menu-footer-social-menu-container li a:hover::after, #menu-footer-links li a:hover::after, .footer-contact li a:hover::after { animation: border 1s ease forwards; width: 100%; }
         ...
         .footer-inquiry-form .form-group                { margin-bottom: 16px; }
         ...
         .new-footer-link li a                           { font-weight: 300; font-size: 18px; line-height: 187%; color: rgba(255,255,255,0.8); display: block; }
         .new-footer-link li                             { line-height: 1; }
         ...
         .new-footer .footer-content                     { padding: 47px 0px 75px; }
        ...
        /* hire dedicated page css starts */
         .dedicated-banner-section                       { position: relative; padding: 170px 0px; background: linear-gradient(0deg, rgba(0, 0, 0, 0.82), rgba(0, 0, 0, 0.82)) no-repeat center center / cover; color: #fff; }
         ...
         .banner-text-box                                { margin: 0 auto; max-width: 80%; text-align: center; }
         .banner-text-box h1                             { margin-bottom:32px; line-height: 1.28125; font-weight: 700; font-family: "Montserrat"; }
         .banner-text-box p                              { margin-bottom:32px; max-width: 83.5%; margin-left: auto; margin-right: auto; font-size: 22px; line-height: 38px; font-weight: 400; opacity: 0.8; }
         ...
         .fd-what-we-do-section h4                       { font-weight: 700;  font-family: 'Montserrat'; }
         .fd-what-we-do-wrapper                          { text-align: center; }
         .fd-what-we-do-wrapper h5                       { margin:10px 0 16px; font-weight: 700; font-size: 22px; line-height: 33px; font-family: 'Montserrat'; color: #1C2530; }
         /* 4d-what-we-do- section end */
         /* our clients css starts */
         .dedicated-page-amp .ourclient-title            { text-align: left; }
         .dedicated-page-amp .slick-prev, .dedicated-page-amp .slick-next { display: none !important; }
         .dedicated-page-amp .hire-now-wrap              { color: #fff; padding: 36px 0px; background: linear-gradient(270deg, rgba(8, 45, 63, 0) -2.99%, rgba(8, 45, 63, 0.86) 16.82%, #082D3F 46.4%, rgba(8, 45, 63, 0.85) 78.88%, rgba(8, 45, 63, 0) 108.1%), url("https://www.yudiz.com/wp-content/themes/yudiz/images/hire-now-bg.png")  no-repeat center center / cover; }
         .dedicated-page-amp h2                          { margin-bottom: 40px; font-family: 'Montserrat'; }
         ...
         .hire-process-tree                              { margin-top: -85px;flex:1;}
         .process-tree-content                           { justify-content:space-between; }
         /* .hire-process-title-box         { padding: 90px 0px; } */
         .hire-process-tree-box                          { background-color: #0C1D3D; padding: 30px 0px; }
         /* .hire-process-tree-box > .container { justify-content: space-between; } */
         .process-number-box                             { padding: 12px 20px; display:flex; align-items:center; justify-content:center; width:105px; height:105px; box-shadow: 0px 4px 20px 9px rgba(0, 0, 0, 0.06); background-color: #fff; border-radius: 100%; }
         .process-number-box h4                          { text-align: center; font-size:42px; line-height:62px; font-weight:700; }
         .process-description                            { margin-top: 30px; }
         .process-description p                          { font-size: 24px; line-height: 32px; font-family: 'Montserrat'; font-weight: 700; color: #fff;  }
         .process-number-wrap                            { position: relative;}
         .hire-process-tree .process-number-wrap::before { content: ''; background: url('https://www.yudiz.com/wp-content/themes/yudiz/images/border-pattern1.svg')no-repeat center center/100% auto; height: 64px; width: calc(100% - 105px); position: absolute; top: 50%; right: 0; transform:translate(0,-50%); display: block;}
         .hire-process-tree:nth-child(2n) .process-number-wrap::before {  background: url('https://www.yudiz.com/wp-content/themes/yudiz/images/border-pattern2.svg')no-repeat center center/100% auto; }
         .hire-process-tree:last-child .process-number-wrap::before { display: none;}
         /* hire process section ends */
         /* technology development section starts */
         .technology-dev-sec                             { padding: 100px 0; background-size: cover !important; background-position: center center !important; }
         .technology-dev-sec h4                          { margin: 0 auto; max-width:40%; text-align: center; color: #fff; }
         .payment-partner-logos                          { margin: -60px auto 0; padding: 70px 0; width: auto; max-width:77%; background: #fff; overflow:hidden; }
         .payment-partner-logos ul                       { margin-bottom: 0; text-align: center;}
         .payment-partner-logos li                       { width: calc(100% / 5 - 5px); display: inline-block; text-align: center; position: relative; }
         .payment-partner-logos li:after                 { content:''; position:absolute; right:0; top:0; transform:translate(-50%,-50%); height:250px; width:1px; background:#EEEEEE;  }
         .payment-partner-logos li:last-child:after      { display:none;  }
         /* technology development section ends */
         .amp-location-img                               { width:28px; }
         /* Hire-Dev-Section why choose us  */
         .hire-dev-why-choose-us                         { background:#F4F6F6; overflow:hidden; }
         .hire-dev-why-choose-us .container > .row       { display:flex; align-items:center; flex-wrap:wrap; }
         .hire-why-choose-content-heading h4             { margin-bottom:24px; font-family: 'Montserrat';font-weight: 800; font-size: 42px; line-height: 62px; color: #0C1D3D; }
         .hire-why-choose-content-heading p              { font-family: 'Poppins'; font-weight: 400; font-size: 21px; line-height: 38px; color: #516385; }
         .hire-why-choose-desc-box                       { position: relative; }
         .hire-why-choose-desc-box:after                 { content:""; position:absolute; width:calc(100% + 1000px); height:459px; top:50%; left:0; transform:translate(0,-50%); background: #D2DDF4; }
         .hire-why-choose-desc-box ul                    { max-width:78%; margin:0 auto; display:flex; align-items:center; text-align:center; flex-wrap:wrap; position:relative; z-index:5; }
         .hire-why-choose-desc-box ul li                 { padding:15px;  width:calc(100%/2); }
         .hire-why-choose-desc-box ul li:nth-child(even) { margin-top:-74px;}
         .hire-dedi-techno-box                           { padding:24px 32px;  background:#fff; min-height:490px; display:flex; align-items:center; flex-direction:column; justify-content: center; box-shadow: 0px -2px 20px rgba(0, 0, 0, 0.06), 12px 10px 20px rgba(0, 0, 0, 0.08); border-radius: 16px; }
         .amp-img-why-choose-section                     { width:120px; height:120px; margin:0 auto;}
         .hire-dedic-dev-desc-box                        { margin-top:24px; }
         .hire-dedic-dev-desc-box h5                     { margin-bottom:24px;  font-family: 'Montserrat';font-weight: 700; font-size: 28px; line-height: 42px; color: #292929; }
         .hire-reso-logo-img                             { position:absolute; width:180px; height:180px; bottom:10%; left:0; transform:translate(-50%,-50%); padding:11px; background:#F4F6F6; border-radius:50%; z-index: 5;}
         .payment-partner-sec                            { background:#F4F6F6; }
         ...
         h6.client-country-name                          { margin-bottom: 32px; font-weight: 500; font-size: 20px; line-height: 32px; color: #666666; font-family: 'Poppins'; letter-spacing: 0; text-transform: none; }
         ...
         .home-testimonial-content .i-amphtml-base-carousel-arrows { display:flex; bottom:auto; left:auto; top:-31%; }
         .home-testimonial-content .i-amphtml-carousel-slotted { padding: 28px 33px; }
         /* Home Testimonials Section  End */
         /* Hiring modal Section Start */
         .hiring-model-amp-section                       { text-align:center; }
         .hiring-model-amp-section h3                    { font-weight: 700; font-size: 42px; line-height: 62px; color: #0C1D3D; font-family: 'Montserrat'; }
         .hiring-model-amp-content > .row                { display:flex; flex-wrap:wrap; }
         .hiring-model-amp-wrapper                       { padding:90px; height:100%; border-top: 4px solid; background: #FFFFFF; transition:all 0.5s ease; }
         .hiring-model-amp-wrapper h5                    { margin-bottom:40px; color: #1C2530; font-family: 'Montserrat'; font-weight:700;}
         .hiring-model-amp-wrapper .price-box-amp        { font-weight: 600; font-size: 42px; line-height: 62px; font-family: 'Poppins'; color: #0487FF; }
         .hiring-model-amp-wrapper .price-box-amp span   { font-family: 'Poppins'; font-style: normal; font-weight: 600; font-size: 24px; line-height: 32px; color: #333333; }
         .hiring-model-amp-wrapper p                     { margin-bottom:40px; font-size: 20px; line-height: 30px; color: #1C2530; }
         .hiring-model-amp-wrapper p:last-child          { margin-bottom:0; }
         .hiring-model-amp-wrapper:hover                 { box-shadow: 1px 10px 32px rgba(0, 0, 0, 0.12); border-radius: 0px 0px 16px 16px; }
         .hiring-amp-saperetor                           { margin-bottom:40px; border: 2px solid #B5B5B5; }
         ...
         /* Exp[ertis] */
          /* Styles for the selector based tabs */
            ...
            .experties-content-box > .row { display: flex; }
            .experties-tabs-content { height: 100%; background:#F5F9FC url('https://www.yudiz.com/wp-content/themes/yudiz/images/experties-tabs-content-pattern-bg.webp')no-repeat right bottom/auto; }
            .experties-tabs-content .tab-content-box { height:100%; padding:40px; border-radius: 12px; }
            .tab-content-box h3 { margin-bottom: 32px; font-family: 'Montserrat'; font-weight: 700; font-size: 32px; line-height: 39px; }
            .tab-content-box h3 a { color:#1C2530; }
            .tab-content-box p { margin-bottom: 32px; color: #333333; }
            .experties-tab-list { display: flex; align-items: center; flex-wrap: wrap;  }
            .experties-tab-list li { margin-bottom: 16px; padding-left: 12px; position: relative; font-weight: 500; font-size: 20px; line-height: 30px; color: #1C2530; width: 50%; }
            .experties-tab-list li:before { content:""; position: absolute; top:50%; left:0; transform: translate(-100%,-50%); width: 8px; height: 8px; border-radius: 50%; background: #0487FF; }
            .tabs-nav-box { height:100%; padding:40px; padding-left: 0 !important; background: #F5F9FC; border-radius: 12px; }
            .tabs-nav-box amp-selector { margin-bottom: 0; }
            .tabs-nav-box amp-selector .tab-amp-nav-li{ margin-bottom: 10px; cursor: pointer; position: relative; display: block; padding:24px 16px 24px 24px; font-weight: 500; font-size: 24px; line-height: 32px; color: #333333; transition: all 0.5s ease; }
            .tabs-nav-box amp-selector .tab-amp-nav-li:hover { text-decoration: none; }
            .tabs-nav-box amp-selector  [option][selected].tab-amp-nav-li:after { opacity: 1; }
            .tabs-nav-box amp-selector .tab-amp-nav-li:hover:after { opacity: 1; }
            .tabs-nav-box amp-selector .tab-amp-nav-li:after { content:''; position: absolute; left:0; top:0; height: 100%; width: 6px; background: #0487FF; opacity: 0; transition: all 0.5s ease; }
            .tabs-nav-box amp-selector .tab-amp-nav-li img { width:40px; height:40px; margin-right: 24px; }
            .experties-tab-technology { margin-bottom: 40px; display: flex; }
            .experties-tab-technology li { width:72px; height:72px; display: flex; justify-content: center; align-items: center; margin-right: 24px; border: 1px solid #D8E0E5; transition:all 0.3s ease-in-out; }
            .experties-tab-technology li:hover img {  filter: grayscale(0%); }
            .experties-tab-technology li img { transition: all 0.5s ease; filter: grayscale(100%); }
            .tabs-nav-box amp-selector .tab-amp-nav-li:last-child a{ margin-bottom: 0; }
            .home-portfolio-section { overflow: hidden; }
            .tab-content-box { transition: all 1s ease-in;  }
            #myTabPanels { height:100%; }
            ...
            .amp-form-section .form-control { padding: 20px; box-shadow:none; height:auto; display:block; background-color: #f8faff; border: none; appearance: none; -webkit-appearance: none; border-radius: 0; font-size: 18px; font-weight: 500; line-height: 22px; color: #1c2530; width: 100%; }
            .amp-form-section .form-group { margin-bottom:45px; }
            ...
            /*  */
            /* 4d-what-we-do- section start */
            .fd-what-we-do-wrapper h5                             { margin:6px 0 10px; font-size: 20px; line-height: 30px; }
            /* Hire-Dev-Section why choose us  */
               .hire-why-choose-content-heading h4                { margin-bottom:20px; font-size: 34px; line-height: 52px;  }
               .hire-why-choose-content-heading p                 {  font-size: 18px; line-height: 32px; }
               .hire-why-choose-desc-box:after                    { height:459px; }
               .hire-why-choose-desc-box ul                       { max-width:78%;  }
               .hire-why-choose-desc-box ul li                    { padding:12px;  width:calc(100%/2); }
               .hire-why-choose-desc-box ul li:nth-child(even)    { margin-top:-74px;}
               .hire-dedi-techno-box                              { padding:20px 28px;  min-height:490px; }
               .amp-img-why-choose-section                        { width:100px; height:100px; }
               .hire-dedic-dev-desc-box                           { margin-top:20px; }
               .hire-dedic-dev-desc-box h5                        { margin-bottom:20px; font-size: 24px; line-height: 34px; }
               .hire-reso-logo-img                                { width:160px; height:160px; bottom:10%; padding:8px; }
               /* hire process section starts */
               .hire-process-tree                                 { margin-top: -61px;flex:1;}
               .hire-process-tree-box                             {  padding: 20px 0px; }
               .process-number-box                                { padding: 8px 14px;  width:80px; height:80px;  }
               .process-number-box h4                             {  font-size:32px; line-height:52px;  }
               .process-description                               { margin-top: 24px; }
               .process-description p                             { font-size: 22px; line-height:30px; }
               .hire-process-tree .process-number-wrap::before    {  height: 57px; width: calc(100% - 80px);}
               .payment-partner-logos                             { margin: -61px auto 0; padding: 60px 0; max-width: 82%; }
               /* Hiring modal Section Start */
               .hiring-model-amp-section h3                       { font-size: 32px; line-height: 50px;  }
               .hiring-model-amp-wrapper                          { padding:60px; border-top: 3px solid;  }
               .hiring-model-amp-wrapper h5                       { margin-bottom:30px;  }
               .hiring-model-amp-wrapper .price-box-amp           { font-size: 34px; line-height: 50px;  }
               .hiring-model-amp-wrapper .price-box-amp span      {   font-size: 20px; line-height: 30px;  }
               .hiring-model-amp-wrapper p                        { margin-bottom:32px; font-size: 20px; line-height: 30px; }
               .hiring-model-amp-wrapper:hover                    {  border-radius: 0px 0px 14px 14px; }
               .hiring-amp-saperetor                              { margin-bottom:32px;  }
               /* Hiring modal Section End */
               /* ===================== Experties Tab Section Start ========================= */
            .experties-tabs-content { background-size: 50% auto; }
            .experties-tabs-content .tab-content-box { padding:30px;  }
            .tab-content-box h3 { margin-bottom: 28px; font-size: 28px; line-height: 34px; }
            .tab-content-box p { margin-bottom: 28px;  }
            .experties-tab-list li { margin-bottom: 12px; padding-left: 8px;  font-size: 16px; line-height: 28px; width: 50%; }
            .experties-tab-list li:before { width: 6px; height: 6px; }
            .tabs-nav-box { padding:30px; }
            .tabs-nav-box amp-selector .tab-amp-nav-li{ margin-bottom: 8px; padding:20px 14px 20px 20px; font-size: 20px; line-height: 30px; }
            .tabs-nav-box amp-selector .tab-amp-nav-li:after { width: 4px; }
            .tabs-nav-box amp-selector .tab-amp-nav-li img { width:30px; height:30px; margin-right: 20px; }
            .experties-tab-technology { margin-bottom: 30px;  }
            .experties-tab-technology li { width:60px; height:60px; margin-right: 16px; }
            .experties-tab-technology li img { width:49px; }
            /* ===================== Experties Tab Section End ========================= */
            /* New Footer Design*/
            ...
            .new-footer .footer-content { padding:40px 0px 65px; }
            /* Form Start */
               ...
               .amp-form-section .form-group { margin-bottom:35px; }
               /* Form End */
            }
         @media(min-width: 1200px) and (max-width: 1599px) {
            ...
            .footer-content { padding: 80px 0px 40px;}
            .footer-logo img { width: 200px;}
            #menu-footer-links li { margin-bottom: 16px; line-height: 24px;}
            .menu-footer-social-menu-container li a { font-size: 16px; line-height: 24px;}
            .footer-contact { padding: 30px;}
            .footer-contact li { font-size: 16px;}
            .site-info { padding: 30px 0px;}
            #menu-copyright-links li { padding: 0px 15px;}
            /* Form Start */
            .amp-form-section label { margin-bottom: 6px; font-size: 16px; line-height: 20px;  }
            ...
            .dropdown-new-menu .sub-menu .sub-menu                { left: calc(100% + 12px); min-width: 240px; }
            ...
            /*============ Investor Menu End ==============*/
            /* 4d-what-we-do- section start */
            .fd-what-we-do-wrapper img                            { width:50px; }
            .fd-what-we-do-wrapper h5                             { margin:6px 0 10px; font-size: 18px; line-height: 28px; }
            /* Hire-Dev-Section why choose us  */
            .hire-why-choose-content-heading h4                   { margin-bottom:20px; font-size: 34px; line-height: 52px;  }
               .hire-why-choose-content-heading p                 {  font-size: 18px; line-height: 32px; }
               .hire-why-choose-desc-box:after                    { height:459px; }
               .hire-why-choose-desc-box ul                       { max-width:89%; margin-right:0;  }
               .hire-why-choose-desc-box ul li                    { padding:12px;  width:calc(100%/2); }
               .hire-why-choose-desc-box ul li:nth-child(even)    { margin-top:-74px;}
               .hire-dedi-techno-box                              { padding:20px 24px;  min-height:410px; }
               .amp-img-why-choose-section                        { width:100px; height:100px; }
               .hire-dedic-dev-desc-box                           { margin-top:20px; }
               .hire-dedic-dev-desc-box h5                        { margin-bottom:20px; font-size: 24px; line-height: 34px; }
               .hire-reso-logo-img                                { width:160px; height:160px; bottom:10%; padding:8px; }
               /* hire process section starts */
               .hire-process-tree                                 { margin-top: -61px;flex:1;}
               .hire-process-tree-box                             { padding: 14px 0px; }
               .process-number-box                                { padding: 8px 14px; width:70px; height:70px;  }
               .process-number-box h4                             { font-size:24px; line-height:38px;  }
               .process-description                               { margin-top: 20px; }
               .process-description p                             { font-size: 20px; line-height:30px; }
               .hire-process-tree .process-number-wrap::before    { height: 57px; width: calc(100% - 70px);}
               .payment-partner-logos                             { margin: -61px auto 0; padding: 60px 0; max-width: 87%; }
               .technology-dev-sec                                { padding:70px 0;  }
               /* Home Testimonials Section  Start */
               .triangle-shape-newhome                            { position: absolute; top:0%; right:0; transform: translate(50%);  }
               ...
               h6.client-country-name                             { margin-bottom: 24px; font-size: 20px; line-height: 32px; }
               .client-testimony-box p                            { font-size: 20px; line-height: 32px; }
               .home-testimonial-content .i-amphtml-carousel-slotted { padding: 16px 26px; }
               /* Home Testimonials Section  End */
               /* Hiring modal Section Start */
               .hiring-model-amp-section h3                       { font-size: 33px; line-height: 48px;  }
               .hiring-model-amp-wrapper                          { padding:40px; border-top: 3px solid;  }
               .hiring-model-amp-wrapper h5                       { margin-bottom:24px;  }
               .hiring-model-amp-wrapper .price-box-amp           { font-size: 26px; line-height: 44px;  }
               .hiring-model-amp-wrapper .price-box-amp span      { font-size: 20px; line-height: 30px;  }
               .hiring-model-amp-wrapper p                        { margin-bottom:26px; font-size: 20px; line-height: 30px; }
               .hiring-model-amp-wrapper:hover                    {  border-radius: 0px 0px 12px 12px; }
               .hiring-amp-saperetor                              { margin-bottom:26px;  }
               /* Hiring modal Section End */
               /* ===================== Experties Tab Section Start ========================= */
               .experties-tabs-content { background-size: 45% auto; }
               .experties-tabs-content .tab-content-box { padding:24px;  }
               .tab-content-box h3 { margin-bottom: 28px; font-size: 28px; line-height: 34px; }
               .tab-content-box p { margin-bottom: 28px;  }
               .experties-tab-list li { margin-bottom: 12px; padding-left: 8px;  font-size: 16px; line-height: 28px; width: 50%; }
               .experties-tab-list li:before { width: 6px; height: 6px; }
               .tabs-nav-box { padding:24px; }
               .tabs-nav-box amp-selector .tab-amp-nav-li{ margin-bottom: 8px; padding:20px 14px 20px 20px; font-size: 20px; line-height: 30px; }
               .tabs-nav-box amp-selector .tab-amp-nav-li:after { width: 4px; }
               .tabs-nav-box amp-selector .tab-amp-nav-li img { width:30px; height:30px; margin-right: 10px; }
               .experties-tab-technology { margin-bottom: 30px;  }
               .experties-tab-technology li { width:60px; height:60px; margin-right: 16px; }
               .experties-tab-technology li img { width:49px; }
               /* ===================== Experties Tab Section End ========================= */
               ...
               .footer-inquiry-form .form-group { margin-bottom: 12px; }
               ...
               .new-footer #menu-copyright-links { margin-bottom: 10px; }
               .new-footer .footer-content { padding: 40px 0px 60px; }
         ...
         @media(min-width:992px) and (max-width:1199px){
            ...
            /*============ Investor Menu End ==============*/
               /* 4d-what-we-do- section start */
               .fd-what-we-do-wrapper img                         { width:40px; }
               .fd-what-we-do-wrapper h5                             { margin:6px 0 10px; font-size: 18px; line-height: 28px; }
               /* hire dedicated page css starts */
               .dedicated-banner-section                             { padding: 130px 0px; }
               .banner-text-box                                      { max-width: 91%; } 
               .banner-text-box p                                    { max-width: 76.5%; font-size: 18px; line-height: 34px; }
               .banner-text-box h2                                   { line-height: 60px; }
               /* Hire-Dev-Section why choose us  */
               .hire-why-choose-content-heading h4                   { margin-bottom:14px; font-size: 26px; line-height: 42px;  }
               .hire-why-choose-content-heading p {  font-size: 16px; line-height: 24px; }
               .hire-why-choose-desc-box:after  { height:300px; }
               .hire-why-choose-desc-box ul     { max-width:91%; margin-right:0;  }
               .hire-why-choose-desc-box ul li  { padding:10px;  width:calc(100%/2); }
               .hire-why-choose-desc-box ul li:nth-child(even) { margin-top:-74px;}
               .hire-dedi-techno-box            { padding:10px 14px;  min-height:360px; }
               .amp-img-why-choose-section      { width:60px; height:60px; }
               .hire-dedic-dev-desc-box         { margin-top:14px; }
               .hire-dedic-dev-desc-box h5      { margin-bottom:14px; font-size: 20px; line-height: 30px; }
               .hire-reso-logo-img              { width:100px; height:100px; bottom:16%; padding:5px; }
               /* hire process section starts */
               .hire-process-tree              { margin-top: -51px; flex:1;}
               .hire-process-tree-box          { padding: 14px 0px; }
               .process-number-box             { padding: 8px 14px; width:70px; height:70px;  }
               .process-number-box h4          { font-size:24px; line-height:38px;  }
               .process-description            { margin-top: 20px; }
               .process-description p          { font-size: 20px; line-height:30px; }
               .hire-process-tree .process-number-wrap::before { height: 57px; width: calc(100% - 70px);}
               .payment-partner-logos           { margin: -61px auto 0; padding: 45px 0; max-width: 87%; }
               .payment-partner-logos li        { padding: 0 10px; }
               .technology-dev-sec              { padding:70px 0;  }
               /* Home Testimonials Section  Start */
               .client-testimony-box { padding:24px; border-radius: 12px; }
               .client-testimony-box:after { width: 81px; height: 55px; right:3%;  }
               h5.client-name-box { margin-bottom: 8px; font-size: 22px; line-height: 30px;  }
               h6.client-country-name { margin-bottom: 20px; font-size: 18px; line-height: 30px; }
               .client-testimony-box p { font-size: 18px; line-height: 30px; }
               .home-testimonial-content .i-amphtml-carousel-slotted { padding: 39px 26px; }
               .home-testimonial-content amp-base-carousel.i-amphtml-layout-size-defined { height:420px !important; }
               /* Home Testimonials Section  End */
               /* Hiring modal Section Start */
               .hiring-model-amp-section h3     { font-size: 33px; line-height: 48px;  }
               .hiring-model-amp-wrapper        { padding:40px; border-top: 3px solid;  }
               .hiring-model-amp-wrapper h5     { margin-bottom:24px;  }
               .hiring-model-amp-wrapper .price-box-amp     { font-size: 26px; line-height: 44px;  }
               .hiring-model-amp-wrapper .price-box-amp span  {   font-size: 18px; line-height: 24px;  }
               .hiring-model-amp-wrapper p      { margin-bottom:26px; font-size: 18px; line-height: 24px; }
               .hiring-model-amp-wrapper:hover  {  border-radius: 0px 0px 12px 12px; }
               .hiring-amp-saperetor            { margin-bottom:26px;  }
               /* Hiring modal Section End */
               /* ===================== Experties Tab Section Start ========================= */
                  .experties-tabs-content { background-size: 45% auto; }
               .experties-tabs-content .tab-content-box { padding:22px;  }
               .tab-content-box h3 { margin-bottom: 24px; font-size: 24px; line-height: 32px; }
               .tab-content-box p { margin-bottom: 24px;  }
               .experties-tab-list li { margin-bottom: 8px; padding-left: 6px;  font-size: 16px; line-height: 28px; width: 50%; }
               .experties-tab-list li:before { width: 5px; height: 5px; }
               .tabs-nav-box { padding:22px; }
               .tabs-nav-box amp-selector .tab-amp-nav-li{ margin-bottom: 8px; padding:16px 12px 16px 16px; font-size: 16px; line-height: 24px; }
               .tabs-nav-box amp-selector .tab-amp-nav-li:after { width: 4px; }
               .tabs-nav-box amp-selector .tab-amp-nav-li img { width:26px; height:26px; margin-right: 10px; }
               .experties-tab-technology { margin-bottom: 24px;  }
               .experties-tab-technology li { width:50px; height:50px; margin-right: 12px; }
               .experties-tab-technology li img { width:40px; }
               /* ===================== Experties Tab Section End ========================= */
               /* Footer Style ============================= */
               .footer-row { padding-top: 40px;}
               ...
               .new-footer .footer-content { padding: 30px 0px 50px; }
         ...
         @media (min-width:768px) and (max-width:991px){
            ...
            */
            ...
            .sub-menu-wrapper ul li .menu-item-desc                { padding-left: 8px; width: calc(100% - 45px); }
            /* 4d-what-we-do- section start */
            .fd-what-we-do-wrapper                                { margin-bottom: 16px; }
            .fd-what-we-do-wrapper img                            { width:40px; }
            .fd-what-we-do-wrapper h5                             { margin:6px 0 10px; font-size: 16px; line-height: 24px; }
               /* hire dedicated page css starts */
               .dedicated-banner-section   { padding: 80px 0px; }
               .banner-text-box            { max-width: 100%; } 
               .banner-text-box p          { max-width: 85%; font-size: 17px; line-height: 32px; }
               .banner-text-box h2         { line-height: 45px; }
               /* Hire-Dev-Section why choose us  */
               .hire-why-choose-content-heading h4 { margin-bottom:10px; font-size: 20px; line-height: 30px;  }
               .hire-why-choose-content-heading p {  font-size:16px; line-height: 24px; }
               .hire-why-choose-desc-box:after  { height: 250px; right: -12%; left:auto; width:100%; }
               .hire-why-choose-desc-box ul     { max-width: 76%; margin-right:0;  }
               .hire-why-choose-desc-box ul li  { padding:8px;  width:calc(100%/2); }
               .hire-why-choose-desc-box ul li:nth-child(even) { margin-top:0px;}
               .hire-dedi-techno-box            { padding:8px 12px;  min-height:250px; }
               .amp-img-why-choose-section      { width:50px; height:50px; }
               .hire-dedic-dev-desc-box         { margin-top:10px; }
               .hire-dedic-dev-desc-box h5      { margin-bottom:10px; font-size: 18px; line-height: 24px; }
               .hire-reso-logo-img              { width: 80px; height: 80px; bottom: 14%; padding: 5px; left: 12%; }
               /* hire process section starts */
               .hire-process-tree              { margin-top: -51px; flex:1;}
               .hire-process-tree-box          { padding: 26px 0px; }
               .process-number-box             { padding: 4px 10px; width:50px; height:50px;  }
               .process-number-box h4          { font-size:16px; line-height:30px;  }
               .process-description            { margin-top: 12px; }
               .process-description p          { font-size: 14px; line-height:22px; }
               .hire-process-tree .process-number-wrap::before { height: 57px; width: calc(100% - 50px);} 
               .payment-partner-logos           { margin: -61px auto 0; padding: 35px 0; max-width: 92%; }
               .payment-partner-logos li        { padding: 0 10px; }
               .technology-dev-sec h4           { max-width:45%; }
               .technology-dev-sec              { padding:50px 0;  }
               /* Home Testimonials Section  Start */
               ...
               .home-testimonial-content amp-base-carousel.i-amphtml-layout-size-defined { height:275px !important; }
                        /* Home Testimonials Section  End */
               ...
               /* Hiring modal Section End */
               /* ===================== Experties Tab Section Start ========================= */
                  .experties-tabs-content { background-size: 37% auto; }
                  .experties-tabs-content .tab-content-box { padding:16px;  }
                  .tab-content-box h3 { margin-bottom: 16px; font-size: 20px; line-height: 30px; }
                  .tab-content-box p { margin-bottom: 16px;  }
                  .experties-tab-list li { margin-bottom: 4px; padding-left: 5px;  font-size: 14px; line-height: 20px; width: 50%; }
                  .experties-tab-list li:before { width: 4px; height: 4px; }
                  .tabs-nav-box { padding:16px; }
                  .tabs-nav-box ul { display: flex; flex-wrap:wrap; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li { width: 50%; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li{ margin-bottom: 6px; padding: 11px 11px 11px 16px; font-size: 16px; line-height: 24px; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li:after { width: 4px; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li img { width:30px; height:30px; margin-right: 8px; }
                  .experties-tab-technology { margin-bottom: 14px;  }
                  .experties-tab-technology li { width:40px; height:40px; margin-right: 12px; }
                  .experties-tab-technology li img { width:32px; }
                  .experties-content-box > .row { display: block; }
                  /* ===================== Experties Tab Section End ========================= */
                  /* Footer Style ============================= */
                  ...
                  #menu-copyright-links li:after { width: 1px;}
                     ...
                     .new-footer #menu-copyright-links { margin-bottom: 8px; }	
                     .new-footer .footer-content { padding: 20px 0px 40px; }
                     ...
                     #menu-copyright-links li { padding: 0px 6px; font-size: 11px; line-height: 20px;}
                     #menu-copyright-links li:after { width: 1px;}
                     ...
                     .new-footer #menu-copyright-links { margin-bottom: 3px; }	
                     .new-footer .footer-content { padding: 20px 0px 40px; }
                     .new-footer .footer-company-review img { max-height: 28px; }
                     .footer-form-box { margin-top: 16px; }
                  /* 	.copyright-social-menu  { order:2; }
                     ...
                     .new-footer-link li { margin:5px; display: inline-block; }
                     .new-footer .site-info > .row { justify-content: center; }
                     .new-footer .footer-company-review { margin-bottom: 7px; } 
         ...
         .banner-text-box            { max-width: 95%; } 
         .banner-text-box p          { max-width: 85%; font-size: 17px; line-height: 28px; }
         .banner-text-box h2         { line-height: 45px; }
         ...
         /* Home Testimonials Section  Start */
                        ...
                        .home-testimonial-content .i-amphtml-carousel-slotted { padding: 24px 21px; }
                        /* Home Testimonials Section  End */
                        /* Hire-Dev-Section why choose us  */
               .hire-why-choose-content-heading h4 { margin-bottom:10px; font-size: 20px; line-height: 30px;  }
               .hire-why-choose-content-heading p {  font-size:16px; line-height: 24px; }
               .hire-why-choose-desc-box:after  { display:none; }
               .hire-why-choose-desc-box ul     { max-width: 100%; display:block; margin-right:0;  }
               .hire-why-choose-desc-box ul li  { padding:8px;  width:100%; }
               .hire-why-choose-desc-box ul li:nth-child(even) { margin-top:0px;}
               .hire-dedi-techno-box            { padding:8px 12px;  min-height:250px; }
               .amp-img-why-choose-section      { width:50px; height:50px; }
               .hire-dedic-dev-desc-box         { margin-top:10px; }
               .hire-dedic-dev-desc-box h5      { margin-bottom:10px; font-size: 18px; line-height: 24px; }
               .hire-reso-logo-img              { display:none; } 
               /* hire process section starts */
               .process-tree-content           { flex-wrap:wrap;  }
               .hire-process-tree              { margin-top: 0; margin:5px 0; flex:1 0 50%;}
               .hire-process-tree br           { display:none; }
               .hire-process-tree-box          { padding: 26px 0px; }
               .process-number-box             { padding: 4px 10px; width:50px; height:50px;  }
               .process-number-box h4          { font-size:16px; line-height:22px;  }
               .process-description            { margin-top: 10px; }
               .process-description p          { font-size: 14px; line-height:20px; }
               .hire-process-tree .process-number-wrap::before { display:none; height: 57px; width: calc(100% - 30px);} 
               .payment-partner-logos           { margin: -15px auto 0; padding: 23px 0; width: auto; max-width: 100%; }
               .payment-partner-logos li        { padding: 0 10px; }
               .technology-dev-sec h4           { max-width:100%; }
               .technology-dev-sec              { padding:40px 0;  }
               /* Hiring modal Section Start */
               .hiring-model-amp-content > .row { justify-content:center; }
               .hiring-model-amp-section h3     { font-size: 28px; line-height: 42px;  }
               .hiring-model-amp-wrapper        { padding:20px; border-top: 2px solid;  }
               .hiring-model-amp-wrapper h5     { margin-bottom:20px;  }
               .hiring-model-amp-wrapper .price-box-amp     { font-size: 24px; line-height: 40px;  }
               .hiring-model-amp-wrapper .price-box-amp span  {   font-size: 18px; line-height: 24px;  }
               .hiring-model-amp-wrapper p      { margin-bottom:20px; font-size: 18px; line-height: 24px; }
               .hiring-model-amp-wrapper:hover  {  border-radius: 0px 0px 12px 12px; }
               .hiring-amp-saperetor            { margin-bottom:20px;  }
               .hiring-model-amp-box            { margin-bottom:24px; max-width:400px; margin:0 auto;}
               /* ===================== Experties Tab Section Start ========================= */
                  .experties-tabs-content { background-size: 70% auto; }
                  .experties-tabs-content .tab-content-box { padding:16px;  }
                  .tab-content-box h3 { margin-bottom: 16px; font-size: 20px; line-height: 30px; }
                  .tab-content-box p { margin-bottom: 16px;  }
                  .experties-tab-list li { margin-bottom: 4px; padding-left: 5px;  font-size: 14px; line-height: 20px; width: 100%; }
                  .experties-tab-list li:before { width: 4px; height: 4px; }
                  .tabs-nav-box { padding:16px; }
                  .tabs-nav-box ul { display: flex; flex-wrap:wrap; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li { width: 100%; z-index: 15; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li{ margin:6px 0; padding: 11px 11px 11px 16px; font-size: 16px; line-height: 24px; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li:after { width: 4px; }
                  .tabs-nav-box amp-selector .tab-amp-nav-li img { width:30px; height:30px; margin-right: 8px; }
                  .experties-tab-technology { margin-bottom: 14px;  }
                  .experties-tab-technology li { width:40px; height:40px; margin-right: 12px; }
            ...
            .site-info small { font-size: 11px;}
                  ...
                  .footer-inquiry-form .form-group { margin-bottom: 10px; }
   ...
   <header id="masthead" class="site-header unset">
      <div class="main-header desktop-mega-header hidden-xs hidden-sm">
         ...
         <div class="desktop-primary-menu">
            <div class="primary-head-menu">
               <div class="menu-primary-mega-menu-container">
                  <ul id="menu-primary-mega-menu" class="menu">
                     ...
                     <li id="menu-item-21885" class=" menu-item menu-item-type-custom menu-item-object-custom menu-item-21885">
                        <a href="#technology">Technology</a>
                     </li>
                     
                     <li id="menu-item-21882" class="menu-item menu-item-type-post_type_archive menu-item-object-portfolio menu-item-21882"><a href="#why-us">Why US</a></li>
                     <li id="menu-item-21886" class=" menu-item menu-item-type-custom menu-item-object-custom menu-item-21886">
                        <a href="#hiring-model">Hiring Model</a>
                     </li>
            ...
            <div class="header-contactus theme-btn solid-blue">
               <a href="#contact-amp-form">Let’s Talk</a>
            </div>
         </div>
      </div>
                        ...
                        <a href="#hiring-model">Hiring Model</a>
                              ...
                              <li id="menu-item-21874"
                                    class="get-in-touch menu-item menu-item-type-post_type menu-item-object-page menu-item-21874"><a
                                       href="#contact-amp-form">Let's Taik</a></li>
                           </ul>
                        </div>
                     </nav>
      </amp-sidebar>
      <!-- .site-header -->
		   <!-- banner section Start -->
            ...
            <section id="clients" class="client-logo-new-section">
               <div class="container">
            ...
            <div id="technology" class="common-section experties-tab-section secondary-bg">
                  <div class="container">
                     <div class="row">
                     <div class="col-sm-8">
                        <h6>We are</h6>
                                    ...
                                    <div class="tab-content-box" id="sample3-tabpanel1" role="tabpanel" aria-labelledby="sample3-tab1" option selected>
                                       <div style="height: 100%; display: flex; flex-direction: column;">
                                             <div>
                                                ...
                                                <ul class="experties-tab-technology"> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-1.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-1.svg" alt="Blockchain Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-2.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-2.svg" alt="Blockchain Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-3.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-3.svg" alt="Blockchain Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-4.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/blockchain-dev-4.svg" alt="Blockchain Development"></li> </ul>
                                             </div>
                                    ...
                                    <div class="tab-content-box" id="sample3-tabpanel2" role="tabpanel" aria-labelledby="sample3-tab2" option>
                                       <div style="height: 100%; display: flex; flex-direction: column;">
                                             <div>
                                                ...
                                                <ul class="experties-tab-technology"> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-1.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-1.svg" alt="Game Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-2.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-2.svg" alt="Game Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-3.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-3.svg" alt="Game Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-4.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-4.svg" alt="Game Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-5.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/game-dev-5.svg" alt="Game Development"></li> </ul>
                                             </div>
                                             <div class="theme-btn solid-blue" style="margin-top: auto; margin-bottom: 0;">
                                    ...
                                    <div class="tab-content-box" id="sample3-tabpanel3" role="tabpanel" aria-labelledby="sample3-tab3" option>
                                       <div style="height: 100%; display: flex; flex-direction: column;">
                                             <div>
                                                ...
                                                <ul class="experties-tab-technology"> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/mobile-app-dev-2.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/mobile-app-dev-2.svg" alt="Mobile App Development "></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/mobile-app-dev-1.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/mobile-app-dev-1.svg" alt="Mobile App Development "></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/mobile-app-dev-3.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/mobile-app-dev-3.svg" alt="Mobile App Development "></li> </ul>
                                             </div>
                                             <div class="theme-btn solid-blue" style="margin-top: auto; margin-bottom: 0;">
                                    ...
                                    <div class="tab-content-box" id="sample3-tabpanel4" role="tabpanel" aria-labelledby="sample3-tab4" option>
                                       <div style="height: 100%; display: flex; flex-direction: column;">
                                             <div>
                                                ...
                                                <ul class="experties-tab-technology"> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-1.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-1.svg" alt="AI/ML Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-2.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-2.svg" alt="AI/ML Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-3.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-3.svg" alt="AI/ML Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-4.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ai-ml-dev-new-4.svg" alt="AI/ML Development"></li> </ul>
                                             </div>
                                             <div class="theme-btn solid-blue" style="margin-top: auto; margin-bottom: 0;">
                                    ...
                                    <div class="tab-content-box" id="sample3-tabpanel5" role="tabpanel" aria-labelledby="sample3-tab5" option>
                                       <div style="height: 100%; display: flex; flex-direction: column;">
                                             <div>
                                                ...
                                                <ul class="experties-tab-technology"> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-1.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-1.svg" alt="AR/VR Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-2.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-2.svg" alt="AR/VR Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-3.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-3.svg" alt="AR/VR Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-4.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ar-vr-new-4.svg" alt="AR/VR Development"></li> </ul>
                                             </div>
                                             <div class="theme-btn solid-blue" style="margin-top: auto; margin-bottom: 0;">
                                    ...
                                    <div class="tab-content-box" id="sample3-tabpanel6" role="tabpanel" aria-labelledby="sample3-tab6" option>
                                       <div style="height: 100%; display: flex; flex-direction: column;">
                                             <div>
                                                ...
                                                <ul class="experties-tab-technology"> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-1.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-1.svg" alt="Website Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-2.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-2.svg" alt="Website Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-3.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-3.svg" alt="Website Development"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-4.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/website-dev-4.svg" alt="Website Development"></li> </ul>
                                             </div>
                                             <div class="theme-btn solid-blue" style="margin-top: auto; margin-bottom: 0;">
                                    ...
                                    <div class="tab-content-box" id="sample3-tabpanel7" role="tabpanel" aria-labelledby="sample7-tab7" option>
                                       <div style="height: 100%; display: flex; flex-direction: column;">
                                             <div>
                                                ...
                                                <ul class="experties-tab-technology"> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-1.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-1.svg" alt="UI/UX Design"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-2.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-2.svg" alt="UI/UX Design"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-4.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-4.svg" alt="UI/UX Design"></li> <li><img class="" src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-3.svg" data-lzy_src="https://www.yudiz.com/wp-content/uploads/2022/09/ui-ux-dev-3.svg" alt="UI/UX Design"></li> </ul>
                                             </div>
                                             <div class="theme-btn solid-blue" style="margin-top: auto; margin-bottom: 0;">
         ...
         <section id="why-us" class="hire-dev-why-choose-us common-section">
            <div class="container">
               <div class="row">
         ...
         <!-- Hire Form section -->
            <section id="contact-amp-form" class="hire-form-section hire-now-section">
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-10 col-md-offset-1">
                  <form class="sample-form" method="post" action-xhr="https://www.yudiz.com/hire-dedicated-resources/api/recaptcha" target="_top" custom-validation-reporting="show-all-on-submit">
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              <label for="name">Full Name</label>
                              <input class="form-control" type="text" id="show-all-on-submit-name" name="name" required pattern="\p{L}+\s\p{L}+">
                              ...
                              <span visible-when-invalid="patternMismatch" validation-for="show-all-on-submit-name">
                                 Please enter your first and last name separated by a space (e.g. Jane Millerrrrr)
                              </span>
                           </div>
                        </div>
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input class="form-control" type="email" id="show-all-on-submit-email" name="email"  required>
                        ...
                        <div class="form-group">
                              ...
                              <input class="form-control" type="tel" name="phone" id="show-all-on-submit-phone" required>
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea class="form-control"  name="message" autoexpand ></textarea>  
                           </div> 
                        </div>
                        <div class="col-md-12">
                           <div class="theme-btn solid-blue text-center">
