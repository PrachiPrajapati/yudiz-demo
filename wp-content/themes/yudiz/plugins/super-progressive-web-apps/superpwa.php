...
if ( ! defined( 'SUPERPWA_PATH_ABS' ) ) {
	define( 'SUPERPWA_PATH_ABS'	, get_stylesheet_directory().'/plugins/super-progressive-web-apps/' ); 
}
...
if ( ! defined( 'SUPERPWA_PATH_SRC' ) ) {
	define( 'SUPERPWA_PATH_SRC'	, get_stylesheet_directory_uri().'/plugins/super-progressive-web-apps/' ); 
}
