			...
			<div class="col-md-10 col-md-offset-1">
				<div class="footer-content">
					<div class="row">
						<div class="col-sm-4">
							<div class="footer-logo">
								...
								if (get_theme_mod('footer_theme_logo')): ?>
																	<img src="<?php echo get_theme_mod('footer_theme_logo'); ?>" loading="lazy" alt="<?php echo esc_attr(get_bloginfo('name', 'display')); ?>">
						...
						<div class="col-sm-4">
							<h6 class="footer-item-title"><strong>Quick Links</strong></h6>
							<?php wp_nav_menu(array("theme_location" => "footer-menu"))?>
						</div>
						<div class="col-sm-4">
							<div class="footer-contact">
								<h6 class="footer-item-title"><strong>Start A Conversation</strong></h6>
								<?php dynamic_sidebar('footer-contact-text');?>
							</div>
						</div>
					</div>
					<div class="footer-address-block footer-row">
						<h6 class="footer-item-title"><strong>Our Locations</strong></h6>
						<div class="row">
							<?php dynamic_sidebar('footer-address-list');?>
						</div>
					</div>
					<div class="footer-row">
						<div class="row">
							<div class="col-sm-8">
								<h6 class="footer-item-title"><strong>Follow Us On</strong></h6>
				...
				<div class="site-info">
					<div class="row">
						<div class="col-sm-6"><small>&copy; <?php echo get_theme_mod('footer_text'); ?></small></div>
						<div class="col-sm-6">
