    ...
    <div class="container">
        <div class="title-bar">
            <div class="row align-center">
                <div class="col-sm-9">
                    <h3 class="bold">Author: <?php echo $category->display_name?></h3>
                </div>
                <!-- <div class="col-sm-3">
        ...
        <div class="mt-64">
        	<div class="project-list-block">
	        	<div class="row main-lists">
		            <?php 
		            echo yspl_blog_data(1,'','',$category->display_name); 
		            ?>
	                ...
	                <div class="text-center mt-64 load-more-main">
	                    <form id="load-more-blog" class="load-more-form">
	                        <div>
	                            ...
	                            <input type="hidden" name="authorVal" value="<?php echo $category->display_name?>" class="authorVal">
